...
void loop() {/*----( LOOP: RUNS CONSTANTLY )----*/
  ...
  if (cont_pulsos_moneda > 0 && millis() - tiempo_pulso > limite_pulsos) {
    cli();/*disable interrupts*/
      nueva_moneda = cont_pulsos_moneda + nueva_moneda; /*Guardo el valor del total de pulsos en esta variable para liberar espacio en la variable cont_pulsos_moneda*/
    sei();
      lcd.clear();
      lcd.setCursor(0,0);
      lcd.print("PULSOS:");/*me alerta en consola que hubo una moneda detectada*/
      lcd.println(nueva_moneda); /* imprime en consola el valor de esa moneda*/
    cli();
