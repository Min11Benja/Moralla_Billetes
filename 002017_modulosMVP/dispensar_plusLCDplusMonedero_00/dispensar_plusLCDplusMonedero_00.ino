...
const int sensor_monedero_pin = 3;
...
volatile unsigned cant_creditos = 0;
...
void setup() {
  ...
  pinMode( sensor_monedero_pin, INPUT_PULLUP );
  attachInterrupt( digitalPinToInterrupt( sensor_monedero_pin), PULSE_CO_mon, RISING);
...
void loop() {
  ...
  //lcd.setCursor(0,0);lcd.print("CREDITOS:");
  lcd.setCursor(0,1);lcd.print(cant_creditos);
  //delay(200);
