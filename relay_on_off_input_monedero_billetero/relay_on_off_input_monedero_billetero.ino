  ...
  /***********************************************************************************************/
    const int limite_pulsos = 1500; /* EDITAR ESTE VALOR PARA CAMBIAR EL DELAY ENTRE DETECCION DE PULSOS-nesecito poner un DELAY es como una pausa entre la deteccion de pulsos para que el arduino me lea los pulsos sin arrojar basura, eh calado multiples valores y 500 es el mas estable*/
  /***********************************************************************************************/
  ...
  pinMode(hopper_pin, INPUT_PULLUP);
...
//delay(VarDelayA);
cont_moneda_expulsada =0;//Variable para
sei();
while (cont_moneda_expulsada < valor_expulsar)
{
...
//**************************************************************************************
//delay(180);
cont_moneda_expulsada = 0; // ERROR IN SPIKES - hopper pulsing effects coin acceptor pulse line!
valor_expulsar=0;
sei();
//**************************************************************************************
